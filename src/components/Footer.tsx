        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="flex space-x-4 pt-2">
              ...
              <a href="https://www.instagram.com/pg_app_studios" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pg-purple transition-colors" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.linkedin.com/in/pg-studios-5b0434353/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pg-purple transition-colors" aria-label="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-400 hover:text-pg-purple transition-colors text-sm">Home</Link></li>
              <li><Link to="/our-apps" className="text-gray-400 hover:text-pg-purple transition-colors text-sm">All iOS Apps</Link></li>
              <li><Link to="/blog" className="text-gray-400 hover:text-pg-purple transition-colors text-sm">Blog</Link></li>
              <li><Link to="/contact" className="text-gray-400 hover:text-pg-purple transition-colors text-sm">Contact</Link></li>
            </ul>
          </div>
